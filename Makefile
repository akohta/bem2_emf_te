...
LDF_MKL =-Wl,--start-group ${MKLROOT}/lib/intel64/libmkl_intel_ilp64.a ${MKLROOT}/lib/intel64/libmkl_gnu_thread.a ${MKLROOT}/lib/intel64/libmkl_core.a -Wl,--end-group -lpthread -lgomp -lm -ldl#mkl lapack link library (static linking) 
# mkl compile option
COP_MKL =-DMKL_ILP64 -m64 -I${MKLROOT}/include
SRCDIR1=d2te_src
SRCDIR2=com_src
OBJDIR =obj
TARGET1=d2te_bv_solver
TRGSRC1=d2te_bv_solver.c
